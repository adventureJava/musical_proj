...
window.onload = function() {
	$(document).ready(function() {
		...
		$('#all_checkbox').on('change',function(){
		 ...
		 $('input[type="checkbox"]').not('#all_checkbox').on('change', function() {
                $('#all_checkbox').prop('checked', $('input[type="checkbox"]').not('#all_checkbox').length === $('input[type="checkbox"]:checked').not('#all_checkbox').length);
        })
		function checked() {
			console.log("checked");
...
<div>
	<label for="all">회원가입 약관에 모두 동의합니다</label>
	<input type="checkbox" id="all_checkbox" name="all"><br>
	<span id="result"></span>
</div><hr>
<div>
...
<div>
	<label for="b">개인정보 수집 및 이용 동의 (필수)</label>
	<input type="checkbox" id="my_checkbox2" name="b">
	<br>
	<p class="agree">
	개인정보처리방침<br>
<br>
...
단, 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인정보(인종 및 민족, 사상 및 신조, 출신지 및 본적지, 정치적 성향 및 범죄기록, 건강상태 등)는 수집하지 않습니다.<br>
<br>
4. 수집하는 개인정보 항목<br>
<br>
본 사이트는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br> 
1) 개인정보 수집방법 : 홈페이지(회원가입)<br>
2) 수집항목 : 생년월일 , 로그인ID , 비밀번호 , 전화번호 , 주소 , 휴대전화번호 , 이메일 , 접속 로그 , 접속 IP 정보 , 결제기록<br>
<br>
<br>
5. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항<br>
<br>
본 사이트는 귀하에 대한 정보를 저장하고 수시로 찾아내는 '쿠키(cookie)'를 사용합니다. 쿠키는 웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷 익스플로러 등)로 전송하는 소량의 정보입니다. 귀하께서 웹사이트에 접속을 하면 본 사이트의 컴퓨터는 귀하의 브라우저에 있는 쿠키의 내용을 읽고, 귀하의 추가정보를 귀하의 컴퓨터에서 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다.<br>
...
3) 쿠키 설정 거부 방법 : 쿠키 설정을 거부하는 방법으로는 귀하가 사용하는 웹 브라우저의 옵션을 선택함으로써 모든 쿠키를 허용하거나 쿠키를 저장할 때마다 확인을 거치거나, 모든 쿠키의 저장을 거부할 수 있습니다. 설정방법 예시 : 인터넷 익스플로어의 경우 → 웹 브라우저 상단의 도구 > 인터넷 옵션 > 개인정보<br>
단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을 수 있습니다.<br>
<br>
6 목적 외 사용 및 제3자에 대한 제공<br>
<br>
본 사이트는 귀하의 개인정보를 "개인정보의 수집목적 및 이용목적"에서 고지한 범위 내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타 기업·기관에 제공하지 않습니다.<br>
...
7. 개인정보의 열람 및 정정<br>
<br>
귀하는 언제든지 등록되어 있는 귀하의 개인정보를 열람하거나 정정하실 수 있습니다. 개인정보 열람 및 정정을 하고자 할 경우에는 "회원정보수정"을 클릭하여 직접 열람 또는 정정하거나, 개인정보 최고관리책임자에게 E-mail로 연락하시면 조치하겠습니다.<br>
...
본 사이트는 개인정보의 수집에 대한 회원탈퇴(동의철회)를 개인정보 수집시와 동등한 방법 및 절차로 행사할 수 있도록 필요한 조치를 하겠습니다.<br>
<br>
9. 개인정보의 보유 및 이용기간<br>
<br>
...
4) 개인정보의 국외 보관에 대한 내용<br>
 회사는 이용자로부터 취득 또는 생성한 개인정보를 미리내가 보유하고 있는 데이터베이스 (물리적보관소: 한국)에 저장합니다. 미리내는 해당 서버의 물리적인 관리만을 행하고, 원칙적으로 회원님의 개인정보에 접근하지 않습니다.<br> 
<br>
<br>
⚪이전항목: 서비스 이용기록 또는 수집된 개인정보<br>
⚪이전국가: 한국<br>
⚪이전일시 및 방법: 전산 서버 수탁계약 이후 서비스 이용 시점에 네트워크를 통한 전송<br>
⚪개인정보 보유 및 이용기간: 회원탈퇴시 혹은 위탁계약 종료시까지 <br>
<br>
10. 개인정보의 파기절차 및 방법<br>
<br>
본 사이트는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.<br>
...
만14세 미만 아동의 법정대리인은 아동의 개인정보의 열람, 정정, 동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 본 사이트는 지체 없이 필요한 조치를 취합니다.<br>
<br>
12. 개인정보 보호를 위한 기술적 대책<br>
<br>
...
개인정보의 처리를 위탁하는 경우에는 위탁계약 등을 통하여 서비스제공자의 개인정보보호 관련 지시 엄수, 개인정보에 관한 비밀유지, 제3자 제공의 금지 및 사고시의 책임부담 등을 명확히 규정하고 당해 계약내용을 서면 또는 전자적으로 보관하겠습니다.<br>
<br>
14. 의견수렴 및 불만처리<br>
...
15. 부 칙(시행일)<br> 
<br>
현 개인정보처리방침은 2017년 9월 22일에 제정되었으며, 정부 및 회사의 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 경우에는 개정 최소 7일 전부터 ‘공지사항’란을 통해 고지하며, 본 정책은 시행 일자에 시행됩니다.<br>
1) 공고일자 : 2018년 05월 01일<br>
2) 시행일자 : 2018년 05월 01일<br> 
	</p>
</div>
<input type="submit" id="join" value="확인">
</form>
</body>
</html>
